...
import { Wrench, Clock, Target, Award, Zap, Shield, Leaf } from "lucide-react";
...
const carouselImages = [
  ...
  '/testimonials/IMG-20251208-WA0011.jpg',
  '/testimonials/IMG-20251208-WA0029.jpg',
  '/testimonials/IMG-20251208-WA0032.jpg',
  '/testimonials/IMG-20251208-WA0033.jpg',
  '/testimonials/IMG-20251208-WA0042.jpg',
    '/testimonials/IMG-20251208-WA0051.jpg',
  '/testimonials/IMG-20251208-WA0058.jpg',
  '/testimonials/IMG-20251208-WA0037.jpg',
  '/testimonials/IMG-20251208-WA0038.jpg',
  '/testimonials/IMG-20251208-WA0027.jpg',
  '/testimonials/IMG-20251208-WA0054.jpg',
  '/testimonials/IMG-20251208-WA0045.jpg',
];
    ...
    <section className="py-20 lg:py-28 bg-gradient-to-b from-white via-[#6497b1]/5 to-white relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="relative w-full h-80 md:h-[450px] lg:h-[500px] overflow-hidden rounded-2xl shadow-xl">
            ...
            <button
              ...
              className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/80 hover:bg-white rounded-full flex items-center justify-center transition-all text-[#011f4b] text-2xl font-bold"
            ...
            <button
              ...
              className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white/80 hover:bg-white rounded-full flex items-center justify-center transition-all text-[#011f4b] text-2xl font-bold"
