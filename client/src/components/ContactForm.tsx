...
/**
 * Hard-coded EmailJS IDs (as requested)
 * Note: Hardcoding public API keys in client code is not recommended for production.
 */
const EMAILJS_SERVICE_ID = "service_15esure";
const EMAILJS_TEMPLATE_ID = "template_grqtn4n";
const EMAILJS_PUBLIC_KEY = "5jgKeXSanMJNmue9h";
    ...
    <div className="relative">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 pt-16">
          ...
          <CardContent>
            <Form {...form}>
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea placeholder="Décrivez votre besoin..." className="min-h-32 resize-none" {...field} data-testid="textarea-message" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <Button type="submit" className="w-full" size="lg" disabled={formState.isSubmitting} data-testid="button-submit-contact">
        ...
        <div className={`space-y-6 transform transition-all duration-1000 delay-300 ${isVisible ? "translate-x-0 opacity-100" : "translate-x-full opacity-0"}`}>
          <Card data-testid="card-contact-info" className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
          ...
          <Card data-testid="card-map" className="overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <CardContent className="p-0 overflow-hidden rounded-lg relative group">
              <div className="absolute inset-0 bg-gradient-to-tr from-green-400/20 to-blue-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none z-10" />
